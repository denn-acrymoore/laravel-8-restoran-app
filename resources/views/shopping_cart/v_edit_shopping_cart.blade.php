...
@section('content')
<form action="/shopping_cart/edit/submit/{{ $currShopping->shopping_cart_id }}" method="post" enctype="multipart/form-data">
        ...
        @foreach ($user as $data)
          @if ($data->type == "user")
            <div class="form-check">
              ...
              value="{{ $data->user_id }}" 
              @if ($currUser->user_id === $data->user_id) 
                  checked
              @endif>
      ...
      <div class="form-group">
        ...
        @foreach ($product as $data)
          <div class="form-check">
            ...
            @if ($currProduct->product_id === $data->product_id) 
                checked
            @endif>
